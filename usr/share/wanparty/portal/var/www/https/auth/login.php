...
$strerror = "";
if(!$logedin && isset($_POST['umail']) && isset($_POST['upass']) && strlen($_POST['umail']) > 3 && strlen($_POST['umail']) < 50 && strlen($_POST['upass']) > 1 && strlen($_POST['upass']) < 25) {
...
<body>
<h2><center><a href="https://<?php echo $_SERVER['SERVER_ADDR']; ?>">Portail WAN-RT</a></center></h2>
</body>
</html>
  <?php
}
...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" method="post" action="login.php">
      ...
      <p class="message"> <b><?php echo $strerror; ?> </b> <br/>Si vous avez oublié votre mot de passe :<br/>demandez aux organisateurs l'accès à une machine ayant un accès suffisant<br/> pour le changer sur le site d'inscription puis consulter votre messagerie !</p>
    </form>
  </div>
</div>
</body>
